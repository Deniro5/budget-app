...
const Header = () => {
  ...
  return (
    <div className={styles.grid}>
      ...
      {!linkSuccess ? (
        <>
          <h4 className={styles.subtitle}>A sample end-to-end integration with Plaid</h4>
          <p className={styles.introPar}>
            The Plaid flow begins when your user wants to connect their bank account to
            your app. Simulate this by clicking the button below to launch Link - the
            client-side component that your users will interact with in order to link
            their accounts to Plaid and allow you to access their accounts via the Plaid
            API.
          </p>
          ...
          {!backend ? (
            <Callout warning>
              ...
              and that your .env file has been configured with your
          ...
          linkToken == null && backend ? (
            <Callout warning>
              ...
              <div>
                If you are on a Windows machine, please ensure that you have cloned the
                repo with{" "}
                <InlineLink
          ...
          {isPaymentInitiation ? (
            <>
              ...
              <p className={styles.requests}>
                Now that the 'payment_id' stored in your server, you can use it to access
